...
public class DexUtils2 {
    private static final String TAG = "DexUtils2";
    ...
    private static class InnerHolder {
        private static final DexUtils2 instance = new DexUtils2();
    }

    public static DexUtils2 get() {
     ...
     * @return 所有class的集合
     */
    public Set<String> getFileNameByPackageName(Context context, final String packageName) throws PackageManager.NameNotFoundException, IOException, InterruptedException {
        Log.d(TAG, "getFileNameByPackageName");
        final Set<String> classNames = new HashSet<>();
        List<String> paths = getSourcePaths(context);
        final CountDownLatch parserCtl = new CountDownLatch(paths.size());
        for (final String path : paths) {
            DefaultPoolExecutor.get().execute(new Runnable() {
                @Override
                public void run() {
    ...
    public List<String> getSourcePaths(Context context) throws PackageManager.NameNotFoundException, IOException {
        ...
        Log.d(TAG, "extractedFilePrefix=" + extractedFilePrefix);
...
//        通过是否存在sp中的multidex.version是不准确的，因为从低版本升级上来的用户，是包含这个sp配置的
        ...
        Log.d(TAG, "getSourcePaths: size=" + sourcePaths.size());
    ...
    private List<String> tryLoadInstantRunDexFile(ApplicationInfo applicationInfo) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && null != applicationInfo.splitSourceDirs) {
            ...
            try {
                ...
                Log.e(TAG, "InstantRun support error, " + e.getCause());
            }
        }
    ...
    private boolean isVMMultidexCapable() {
        ...
        try {
            ...
            Log.e(TAG, "isVMMultidexCapable: " + ignore.getCause());
        }
    ...
    private boolean isYunOS() {
        try {
            ...
            Log.e(TAG, "isYunOS: " + ignore.getCause());
            return false;
        }
    }
}
